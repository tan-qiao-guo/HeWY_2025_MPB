...
**Table 2. Distribution coefficients (*K*<sub>d</sub>) of metals between diatoms and seawater, and assimilation efficiencies (*AE*) of diatom-bound metals in clams (*Ruditapes philippinarum*).**

<div style="font-size: 85%; border: 1px solid #ccc; padding: 1em;">

| Metal | log *K*<sub>d</sub> (L kg^-1^) | AE (%)<sup>a</sup> | AE (%)<sup>b</sup> |
|:--------------|:--------------------------|:-------------------------|:-------------------------| 
...
<sub>Values are mean ± standard deviation. See Note S1 for the determination of *K*<sub>d</sub>.</sub>  
<sub><sup>a</sup> AE determined using Equation 11 and model-fitted parameter values from **Table 1**, averaged across 2-day and 5-day diatom cultures.</sub>  
<sub><sup>b</sup> AE determined from direct measurements using whole-cell diatoms (see Section 2.3).</sub>  
